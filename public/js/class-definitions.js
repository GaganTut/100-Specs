...
BankAccount.prototype.deposit = function(amount, owner) {
  owner.money -= amount;
  this.balance += amount;
};

BankAccount.prototype.rob = function(amount, anyPerson) {
  this.balance -= amount;
  anyPerson.money += amount;
};
 ...
 *
 */
var farTooTallAStory = singleStory.isATallStory(1);
var shortStory = twoStory.isATallStory(5);
